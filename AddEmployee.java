...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    JTextField tfname,tffname,tfaddress,tfnumber,tfsalary ,tfaadhar,tfemail,tfdesignation;
    JDateChooser dcdob;
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == add){
            ...
            try{
                ...
                String query ="insert into employee values('"+name+"','"+fname+"','"+dob+"','"+salary+"','"+address+"','"+number+"','"+email+"','"+education+"','"+designation+"','"+aadhar+"','"+empId+"')";
